...
$nuspecFiles = @{
    "Flash.Configuration.nuspec" = "Flash.Configuration"
    "Flash.Configuration.Wpf.nuspec" = "Flash.Configuration.Wpf"
    "Flash.Configuration.WinForms.nuspec" = "Flash.Configuration.WinForms"
}
